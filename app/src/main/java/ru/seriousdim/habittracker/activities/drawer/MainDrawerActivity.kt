package ru.seriousdim.habittracker.activities.drawer
...
import ru.seriousdim.habittracker.databinding.ActivityMainDrawerBinding
...
class MainDrawerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_habit_list, R.id.nav_info
            ), drawerLayout
        )
